...
public class exercicioProposto2 {
	public static void main(String[] args) {
		...
		minhasLinguagensFavoritas.add(new LinguagemFavorita("PostgreSQL", 1997, "PgAdmin"));

		System.out.println("--------\tOrdem de Inserção\t--------");
		Set<LinguagemFavorita> minhasLinguagensFavoritas1 = new LinkedHashSet<>(Arrays.asList(
				new LinguagemFavorita("Java", 1991, "Eclipse"), new LinguagemFavorita("JavaScript", 1995, "Visual Studio Code"),
				new LinguagemFavorita("PostgreSQL", 1997, "PgAdmin")));
